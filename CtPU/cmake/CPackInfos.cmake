...
if (UNIX)
    ...
    if (CMAKE_SYSTEM_NAME MATCHES "Linux")
        ...
        install(
            FILES utils/udev_rules/60-ctpu.rules
    ...
    elseif(CMAKE_SYSTEM_NAME MATCHES "FreeBSD")
        ...
        install(
            FILES utils/devd_rules_freebsd/ctpu.conf
    ...
    install(
        ...
        DESTINATION share/doc/ctpu-bintape-timechannel
    )
    # install application starter and icons
    install(
        FILES utils/applications/org.ctpu.CtpuBintapeTimechannel.desktop
        DESTINATION share/applications
        )
    install(
        FILES ctpu/res/images/ctpu.png
        DESTINATION share/icons/hicolor/48x48/apps
    )
    install(
        FILES ctpu/res/images/ctpu.svg
...
set(CPACK_PACKAGE_CONTACT "dtba3a@gmail.com")
set(CPACK_PACKAGE_VENDOR "CtPU/BinTape/TimeChannel")
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Digital oscilloscope software for Hantek DSO6022 USB hardware")
set(CPACK_PACKAGE_DESCRIPTION "CtPU/BinTape/TimeChannel: measurement software for\nthe InstruStar ISDS205B USB oscilloscope (fx2lafw + libusb path)")
