...
set(CTPU_DOCS_DIR "${CMAKE_CURRENT_LIST_DIR}/../docs")
set(DOCUMENTS_DIR "documents")

# set file names for doc files
set(USER_MANUAL "${CTPU_DOCS_DIR}/manual")
set(AC_MOD "${CTPU_DOCS_DIR}/HANTEK6022_AC_Modification.pdf")
set(FG_MOD "${CTPU_DOCS_DIR}/HANTEK6022_Frequency_Generator_Modification.pdf")
...
add_custom_command(
    ...
    COMMAND ${CMAKE_COMMAND} -E copy_directory "${USER_MANUAL}" "$<TARGET_FILE_DIR:${PROJECT_NAME}>/${DOCUMENTS_DIR}/manual"
