...
namespace Dso {
Enum< Dso::TriggerMode, Dso::TriggerMode::AUTO, Dso::TriggerMode::FREERUN > TriggerModeEnum;
...
Enum< Dso::MathOp, Dso::MathOp::ADD, Dso::MathOp::DIV > MathOpEnum;
...
QString triggerModeString( TriggerMode mode ) {
    ...
    case TriggerMode::FREERUN:
        return QCoreApplication::tr( "Free run" );
    }
    return QString();
}
